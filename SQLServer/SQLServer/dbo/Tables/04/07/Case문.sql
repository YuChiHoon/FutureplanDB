...
(
	...
	ProductCount Int Default(0),							-- 제고수량
	RegistDate DateTime Default(GetDate()),					-- 상품등록일
	Mileage Int Null,										-- 마일리지(적림금)
...
Values
(
	1, 'COM-01', '좋은컴퓨터', '우리집', 10000, 8000,'NEW', 'COM-01.jpg', '좋은컴퓨터입니다.',
	'좋은컴퓨터입니다...', 'Text', 100, GetDate(), 0, 0
);
Insert Into Products
Values
(
	2, 'BOOK-01', '좋은책', '우리집', 8000, 5000,'HIT', 'BOOK-01.jpg', '좋은책입니다.',
	'좋은책입니다...', 'Text', 100, GetDate(), 0, 0
);
Insert Into Products
Values
(
	3, 'SOFTWARE-01', '좋은강의', '우리집', 10000, 8000,'BEST', 'SOFTWARE-01.jpg', '좋은강의입니다.',
	'좋은강의입니다...', 'Text', 100, GetDate(), 0, 0
);
