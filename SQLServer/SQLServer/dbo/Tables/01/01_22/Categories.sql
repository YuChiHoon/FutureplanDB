...
(
	...
	--
	SuperCategory	Int Null References Categories(CategoryId),			-- 부모카테고리번호(확장용) : ParentId, ParentCategoryId로 이름 변경해도 무관
	Align			SmallInt Default(0)									-- 카테고리 보여지는 순서
)
Go
...
--Insert Into Categories Values(N'책',Null, 1)
--Go
--Insert Into Categories Values(N'강의',Null, 2)
--Go
--Insert Into Categories Values(N'컴퓨터',Null, 3)
--Go
...
-- 대중소 분류로 확장한다면...
--Insert Into Categories Values(N'노트북',3, 1)
--Go
--Insert Into Categories Values(N'데스크톱',3, 2)
--Go
--Insert Into Categories Values(N'삼성',4, 1)
--Go
